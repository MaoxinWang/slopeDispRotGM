...
sigma_lnD = (c(1)+log(D_nonzero))./(c(2)+c(3)*log(D_nonzero).^2)+c(4);
sigma_lnD(log(D_nonzero)<boundlnD_sigma(1)) = (c(1)+boundlnD_sigma(1))/(c(2)+c(3)*boundlnD_sigma(1)^2)+c(4);
sigma_lnD(log(D_nonzero)>boundlnD_sigma(2)) = (c(1)+boundlnD_sigma(2))/(c(2)+c(3)*boundlnD_sigma(2)^2)+c(4);
